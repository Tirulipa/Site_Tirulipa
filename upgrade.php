...
<html lang="br">
	...
	<div class="w3-padding-large" id="main">
		...
		<!-- Header/Home -->
		<header class="  w3-center "  id="home1">
			...
			<div class="inner">
				<div class="thumbnails">
					<div class="box">
						...
						<div class="inner">
							<h3>Seguro Prata Supreme</h3>
							<p>Descrição do tipo do seguroDescrição do tipo do seguro.Descrição do tipo do seguro</br><li>Vantagem 1</li></br></br>Preço: R$: 30,000.00</p>
					...
					<div class="box">
						...
						<div class="inner">
							<h3>Seguro Ouro Supreme</h3>
							<p>Descrição do tipo do seguroDescrição do tipo do seguro.Descrição do tipo do seguro</br><li>Vantagem 1</li></br><li>Vantagem 2</li></br>Preço: R$: 30,000.00</p>
					...
					<div class="box">
						...
						<div class="inner">
							<h3>Seguro Premium Supreme</h3>
							<p>Descrição do tipo do seguro.Descrição do tipo do seguroDescrição do tipo do seguro</br><li>Vantagem 1</li></br><li>Vantagem 2</li></br><li>Vantagem 3</li></br>Preço: R$: 30,000.00</p>
